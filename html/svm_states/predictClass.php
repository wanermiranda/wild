...
<?php    
    ...
    if ($descriptor == "bic" || $descriptor == "sasi" || $descriptor == "eoac"){
        ...
        $predict_cmd = "predict/predict ".$descriptor. " svm_states/train2.".$descriptor.".xml" . " images/". $filename;
        echo $predict_cmd . "<br>";
        exec($predict_cmd, $out2);
        echo $out2[count($out2)-1];
        
    //echo $out2[0] . "<br>";
    }
?>
<LABEL>Imagem:</LABEL>
<img src="images/<?php echo $filename?>" alt="Imagem" >
</DIV>
</BODY>